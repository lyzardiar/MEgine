...
impl Default for TargetJoint2D {
    fn default() -> Self {
        Self {
            enabled: true,
            anchor: [0.0, 0.0],
...
impl Component for TargetJoint2D {
    fn type_name() -> &'static str {
        "TargetJoint2D"
    }
    fn as_any(&self) -> &dyn std::any::Any {
...
pub struct Canvas {
    ...
    pub override_pixel_perfect: bool,
...
impl Component for GraphicRaycaster {
    fn type_name() -> &'static str {
        "GraphicRaycaster"
    }
    fn as_any(&self) -> &dyn std::any::Any {
...
pub struct LayoutElement {
    ...
    pub grid_horizontal_align: String,
    pub grid_vertical_align: String,
}
...
impl Default for LayoutElement {
    fn default() -> Self {
        Self {
            ...
            flexible_height: -1.0,
            baseline: -1.0,
            horizontal_align: "Auto".into(),
            vertical_align: "Auto".into(),
            grid_column: -1,
            grid_row: -1,
            grid_column_span: 1,
            grid_row_span: 1,
            grid_horizontal_align: "Auto".into(),
            grid_vertical_align: "Auto".into(),
        }
    }
}
...
impl Default for Button {
    fn default() -> Self {
        Self {
            ...
            highlighted_color: [0.9607843, 0.9607843, 0.9607843, 1.0],
            pressed_color: [0.7843137, 0.7843137, 0.7843137, 1.0],
            selected_color: [0.9607843, 0.9607843, 0.9607843, 1.0],
            disabled_color: [0.5215686, 0.5215686, 0.5215686, 0.5019608],
            color_multiplier: 1.0,
            fade_duration: 0.1,
            highlighted_sprite: "".into(),
            pressed_sprite: "".into(),
            selected_sprite: "".into(),
            disabled_sprite: "".into(),
            label: "Button".into(),
...
pub struct LayoutGroup {
    ...
    pub main_axis_distribution: String,
    pub counter_axis_distribution: String,
    pub counter_axis_alignment: String,
    pub cell_size: [f32; 2],
    ...
    pub grid_rows: i32,
    pub grid_fit_width: bool,
    pub grid_fit_height: bool,
}
...
impl Default for LayoutGroup {
    fn default() -> Self {
        Self {
            ...
            counter_axis_distribution: "Packed".into(),
            counter_axis_alignment: "Auto".into(),
