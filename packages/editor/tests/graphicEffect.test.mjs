...
test('shadow and four outline directions compose without changing source material state', () => {
  const filter = graphicEffectFilter(
    ...
    { color: [1, 0.5, 0, 0.75], distance: [1, -2], useGraphicAlpha: true },
  );
...
test('alpha-independent effects are reserved for explicit geometry rendering', () => {
  assert.equal(
    graphicEffectFilter(
      { color: [0, 0, 0, 0.5], distance: [2, 3], useGraphicAlpha: false },
