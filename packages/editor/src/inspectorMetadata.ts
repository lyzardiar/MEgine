...
> = {
  ...
  Button: {
    ...
    highlighted_color: { label: 'Highlighted Color', visibleWhen: { field: 'transition', equals: 'ColorTint' } },
    pressed_color: { label: 'Pressed Color', visibleWhen: { field: 'transition', equals: 'ColorTint' } },
    selected_color: { label: 'Selected Color', visibleWhen: { field: 'transition', equals: 'ColorTint' } },
  ...
  TrailRenderer2D: {
    time: { min: 0.01, step: 0.05 },
    min_vertex_distance: { min: 0.001, step: 0.01 },
    max_points: { min: 2, max: 2048, step: 1 },
    width_start: { min: 0, step: 0.01 },
    width_end: { min: 0, step: 0.01 },
    texture: { ...sprite, noneValue: '' },
    blend_mode: { kind: 'enum', options: options('alpha', 'additive') },
    sorting_layer: { label: 'Sorting Layer', kind: 'enum' },
  },
  ...
  Text: {
    ...
    support_rich_text: { label: 'Rich Text' },
