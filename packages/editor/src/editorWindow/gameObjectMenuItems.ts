...
createItem('Camera', 200, ({ store }) => store.spawnCamera());
...
createItem('UI/Progress Bar', 315, ({ store }) => store.spawnUiProgressBar());
createItem('UI/Input Field', 316, ({ store }) => store.spawnUiInputField());
createItem('UI/Dropdown', 317, ({ store }) => store.spawnUiDropdown());
createItem('UI/List View', 318, ({ store }) => store.spawnUiListView());
createItem('UI/Scroll View', 319, ({ store }) => store.spawnUiScrollView());
createItem('UI/Tab View', 320, ({ store }) => store.spawnUiTabView());
