...
createItem('Effects/Trail Renderer 2D', 122, ({ store }) => store.spawnTrailRenderer2D());
createItem('Effects/2D Particle Presets/Fire', 123, ({ store }) => store.spawnParticleEmitter2DPreset('fire'));
createItem('Effects/2D Particle Presets/Smoke', 124, ({ store }) => store.spawnParticleEmitter2DPreset('smoke'));
createItem('Effects/2D Particle Presets/Spark Burst', 125, ({ store }) => store.spawnParticleEmitter2DPreset('spark_burst'));
createItem('Effects/2D Particle Presets/Magic Aura', 126, ({ store }) => store.spawnParticleEmitter2DPreset('magic_aura'));
createItem('Effects/2D Particle Presets/Snow', 127, ({ store }) => store.spawnParticleEmitter2DPreset('snow'));
...
createItem('Light/Environment', 211, ({ store }) => store.spawnEnvironmentLight());
createItem('Light/Point', 212, ({ store }) => store.spawnPointLight());
createItem('Light/Spot', 213, ({ store }) => store.spawnSpotLight());
createItem('Light/2D/Global', 214, ({ store }) => store.spawnLight2D('global'));
createItem('Light/2D/Point', 215, ({ store }) => store.spawnLight2D('point'));
...
createItem('UI/Spine Skeleton', 313.1, ({ store }) => store.spawnUiSpine());
createItem('UI/Effekseer Effect', 313.2, ({ store }) => store.spawnUiEffekseer());
...
createItem('UI/Layout/Horizontal Layout Group', 410, ({ store }) => store.spawnUiLayoutGroup('Horizontal'));
createItem('UI/Layout/Vertical Layout Group', 411, ({ store }) => store.spawnUiLayoutGroup('Vertical'));
createItem('UI/Layout/Grid Layout Group', 412, ({ store }) => store.spawnUiLayoutGroup('Grid'));
createItem('UI/Templates/Inventory', 420, ({ store }) => store.spawnGameUiTemplate('inventory'), { separatorBefore: true });
createItem('UI/Templates/Leaderboard', 421, ({ store }) => store.spawnGameUiTemplate('leaderboard'));
createItem('UI/Templates/Shop', 422, ({ store }) => store.spawnGameUiTemplate('shop'));
